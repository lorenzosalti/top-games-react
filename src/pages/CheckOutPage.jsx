                ...
                <div className="row justify-content-center mb-5">
                    <div className="col-md-8 col-lg-6">
                        <div className="container p-4 border rounded shadow bg-dark text-white">
                            <h4 className="mb-3 text-white text-center">🛒 Riepilogo Carrello</h4>
                            {cartStorage.length ? (
                                <>
                                    ...
                                    <div className="d-flex align-items-center justify-content-between bg-dark text-white p-3 border rounded">
                                        ...
                                        <input type="text" className="form-control me-2" id="discount-input" style={{ flex: 1, maxWidth: '150px' }} onChange={handleDiscountData} />
                                ...
                                <p className="text-white text-center">Il carrello è vuoto.</p>
                            )}
                        </div>
                    </div>
                </div>
                ...
                <div className="row justify-content-center">
                    ...
                    <div className="col-lg-6 mb-4">
                        <form className="container p-4 border rounded shadow bg-dark text-white needs-validation h-100" onSubmit={handleSubmit} ref={formRef} noValidate>
                            ...
                            <button type="submit" className="btn btn-warning text-black w-100">
                                Conferma
                            </button>
                        </form>
                    </div>
